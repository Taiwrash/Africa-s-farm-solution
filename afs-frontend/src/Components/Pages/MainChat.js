    ...
    <div className="mainchat">
      <div className="chatBox">
        ...
        <ScrollToBottom className="messages">
          {view ? messages.map(({ username, message, _id }) => (
        ...
        <div className="chat-input">
          <input type="text" value={msg} onChange={onMessage} className="chat-bar" placeholder="type something here..." />

          <button type="submit" onKeyPress={onSendMessage} onClick={onSendMessage} className="chat-button">
            {' '}
